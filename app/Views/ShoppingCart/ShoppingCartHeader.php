...
<head>
    ...
    <title>My Shopping Cart - EZ Market</title>
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link mx-2 active-page selected" href="/homepage/shoppingCart">
                        <i class="fa badge fa-lg" style="font-size:1.5em" data-value="<?php echo isset($_SESSION['cartItems']) ? count($_SESSION['cartItems']) : 0; ?>">&#xf07a;</i>
                    </a>
                </li>
